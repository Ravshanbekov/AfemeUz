    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                @can('material-create')
                    <a href="{{ route('admin.materials.create') }}" style="margin-left: 25px"
                                        ...
                                        <td style="width: 50px">
                                            @can('material-edit')
                                                <a style="margin-top: 15px" class="btn btn-info btn btn-block btn-sm"
                                                    href="{{ route('admin.materials.edit', $material->id) }}"><i
                                                        class="far fa-edit text-white"></i></a>
                                            @endcan
                                            @can('material-list')
                                                <a class="btn btn-secondary btn btn-block btn-sm"
                                                    href="{{ route('admin.materials.show', $material->id) }}"><i
