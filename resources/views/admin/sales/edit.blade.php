        ...
        <div class="card col-lg-12">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label>Sotish nomi Uz</label>
                    <input type="text" value="{{ $sale->name_uz }}" class="form-control form-control-sm" name="name_uz">
                </div> <div class="form-group">
                    <label>Sotish nomi En</label>
                    <input type="text" value="{{ $sale->name_en }}" class="form-control form-control-sm" name="name_en">
                </div>
                 <div class="form-group">
                    <label>Sotish nomi Ru</label>
                    <input type="text" value="{{ $sale->name_ru }}" class="form-control form-control-sm" name="name_ru">
                </div>
                <div class="form__imgUploader">
                    <div class="form__wrapper">
                        <div class="form__image">
                            <img src="/admin2/sales/{{ $sale->icon }}" alt="" class="form__img">
                        </div>
