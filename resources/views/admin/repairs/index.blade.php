    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                @can('repair-create')
                    <a href="{{ route('admin.repairs.create') }}" style="margin-left: 25px"
                        class="btn btn-outline-primary btn-sm col-lg-2"><i class="fas fa-plus"></i></a>
                @endcan
                <div class="card-body">
