        ...
        <div class="card col-lg-12">
            ...
            <div class="card-body">
                 <div class="form-group">
                     <label>Faollik</label>
                     <select name="status" value="{{ $logo->status }}" class="form-control">{{ $logo->status }}
                         <option {{ $logo->status == 1 ? 'selected' : '' }} value="1">Faol</option>
                         <option {{ $logo->status == 0 ? 'selected' : '' }} value="0">Faol emas</option>
                     </select>
                 </div>
               <div class="form__imgUploader">
                    <div class="form__wrapper">
                        <div class="form__image">
                            <img src="{{ $logo->image }}" alt="" class="form__img">
                        </div>
                        <div class="formUploader__content">
                            <div class="formUploader__icon"><i class="fas fa-cloud-upload-alt"></i></div>
                            <div class="formUploader__text"> 150x50 rasim krting ! !</div>
                        </div>
