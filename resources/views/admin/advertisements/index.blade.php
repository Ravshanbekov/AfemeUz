        ...
        <div class="col-12">
            <div class="card">
                ...
                @can('advertisement-create')
                    <a href="{{ route('admin.advertisements.create') }}" style="margin-left: 25px"
                            ...
                            <tbody>
                                ...
                                @foreach ($advertisements as $advertisement)
                                    <tr style="text-align-last: center">
                                        ...
                                        <td><img src="{{ $advertisement->image }}" width="150"></td>
                                       <td>
                                        ...
                                        <td>{{ $advertisement->created_at->format('Y-m-d'); }}</td>
                                        <td>{{ $advertisement->updated_at->format('Y-m-d'); }}</td>
                                        <td style="width: 50px">
